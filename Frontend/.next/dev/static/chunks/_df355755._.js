...
"[project]/components/consultation-details.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ConsultationDetails({ consultationId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConsultationDetails.useEffect": ()=>{
            const fetchReportDetails = {
                "ConsultationDetails.useEffect.fetchReportDetails": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$consultas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getValidatedReportDetailsRequest"])(token, consultationId);
                        if (response.ok) {
            ...
            }["ConsultationDetails.useEffect.fetchReportDetails"];
            fetchReportDetails();
        }
    }["ConsultationDetails.useEffect"], []);
    ...
    const markAsDone = (consultationId)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$consultas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["consultaMarkAsDone"])(localStorage.getItem("token") || "", consultationId);
...
_s(ConsultationDetails, "qC+M1DDjTjx5QpcrEqMPh0z7h34=", false, function() {
    return [
...
//# sourceMappingURL=_df355755._.js.map
...
function Select({ ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$radix$2d$ui$2b$react$2d$select$40$2$2e$2$2e$_39f8603e6e6d604f77796307f5a5c4f3$2f$node_modules$2f40$radix$2d$ui$2f$react$2d$select$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Root"], {
        "data-slot": "select",
        ...props
    }, void 0, false, {
...
function Slider({ className, defaultValue, value, min = 0, max = 100, ...props }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$radix$2d$ui$2b$react$2d$slider$40$1$2e$3$2e$_ac879882dcfbd7751c395195f4989566$2f$node_modules$2f40$radix$2d$ui$2f$react$2d$slider$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Root"], {
        "data-slot": "slider",
...
"[project]/components/symptom-form.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SymptomForm({ preloadedSymptoms } = {}) {
        ...
        "SymptomForm.useEffect": ()=>{
            ...
            async function loadSymptoms() {
                ...
                try {
                    ...
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$sintomas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listSintomasRequest"])();
                    let items = [];
                    if (res.ok) {
                    ...
                    if (!res.ok || items.length === 0) {
                        const mockRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$sintomas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listMockSintomasRequest"])();
                    ...
                    const names = items.map({
                        "SymptomForm.useEffect.loadSymptoms.names": (it)=>it.nome || it.name || String(it)
                    }["SymptomForm.useEffect.loadSymptoms.names"]);
                    if (mounted) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SymptomForm.useEffect": ()=>{
            ...
            const timeout = setTimeout({
                "SymptomForm.useEffect.timeout": async ()=>{
                    try {
                        setNlpLoading(true);
                        setNlpError(null);
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$sintomas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchSymptomsNlpRequest"])(descriptionText, 6);
                        if (!res.ok) throw new Error(`Erro ao sugerir sintomas: ${res.status}`);
                        const json = await res.json();
                        const names = Array.isArray(json.data) ? json.data.map({
                            "SymptomForm.useEffect.timeout": (it)=>it.name || it.nome || String(it)
                        }["SymptomForm.useEffect.timeout"]) : [];
                        // Mescla evitando duplicados
                        setPossibleSymptoms({
                            "SymptomForm.useEffect.timeout": (prev)=>{
            ...
            }["SymptomForm.useEffect.timeout"], 400); // debounce
            return ({
                "SymptomForm.useEffect": ()=>{
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            // Enviar ao back-end
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$consultas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeConsultaRequest"])(token, selectedSymptomIds, description.trim() || undefined);
            if (!response.ok) {
...
_s(SymptomForm, "qCdmZ2Y31aiJMu62IeuOMu7NOMA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
"[project]/components/symptom-form-preloader.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@16.0.6_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/next@16.0.6_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$symptom$2d$form$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/symptom-form.tsx [app-client] (ecmascript)");
...
function SymptomFormPreloader({ minLoadingDuration = 2500 }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SymptomFormPreloader.useEffect": ()=>{
            const preloadData = {
                "SymptomFormPreloader.useEffect.preloadData": async ()=>{
                    try {
                        ...
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$sintomas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listSintomasRequest"])();
                        let items = [];
                        if (response.ok) {
            ...
            }["SymptomFormPreloader.useEffect.preloadData"];
            preloadData();
        }
    }["SymptomFormPreloader.useEffect"], [
        router
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            !isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$symptom$2d$form$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SymptomForm"], {
...
_s(SymptomFormPreloader, "iOIxXtP7xU44Tj56X+5OZCBYh08=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = SymptomFormPreloader;
var _c;
__turbopack_context__.k.register(_c, "SymptomFormPreloader");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_e159681f._.js.map
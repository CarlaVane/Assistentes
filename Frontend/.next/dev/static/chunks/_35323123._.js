...
function Drawer({ ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$vaul$40$1$2e$1$2e$2_$40$types$2b$react$2d$dom_472455800af3f6a711a001447cda5b77$2f$node_modules$2f$vaul$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Drawer"].Root, {
        "data-slot": "drawer",
        ...props
    }, void 0, false, {
...
function UserManagement() {
    ...
    const fetchUsers = async ()=>{
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listUsersRequest"])(token || "");
            if (!res.ok) {
    ...
    const handleSubmit = async ()=>{
        ...
        if (!editingUserId && !body.password) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("A password é obrigatória para criar um utilizador");
            return;
        }
        if (!body.tipo) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("O perfil (tipo) é obrigatório");
            return;
        }
        try {
            let res;
            if (editingUserId) {
                ...
                res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUserRequest"])(editingUserId, body, token || undefined);
            } else {
                res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserRequest"])(body, token || undefined);
            }
            if (!res.ok) {
                const payload = await res.json().catch(()=>null);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(payload?.message || `Erro: ${res.status}`);
                return;
            }
            // sucesso
            const successMsg = editingUserId ? "Utilizador atualizado com sucesso" : "Utilizador criado com sucesso";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(successMsg);
                    ...
                    if (createdUser && (createdUser._id || createdUser.id)) {
                        ...
                        if (form.predisposicoes) {
                            try {
                                ...
                                if (names.length > 0) {
                                    const dRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$doenca$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listDoencasRequest"])();
                                    if (dRes.ok) {
                                        ...
                                        if (ids.length > 0) predisposicoesIds = ids;
                                            ...
                                            // no matches — warn
                                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning('Nenhuma predisposição correspondeu aos nomes informados; será enviada vazia.');
                                        }
                                    } else {
                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning('Não foi possível obter lista de doenças para mapear predisposições.');
                                    }
                                }
                            } catch (err) {
                        ...
                        const pacienteRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$pacientes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPacienteRequest"])(token || "", pacienteBody);
                        if (!pacienteRes.ok) {
                            const pErr = await pacienteRes.json().catch(()=>null);
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].warning(`Utilizador criado, mas não foi possível criar o perfil do paciente: ${pErr?.message || pacienteRes.status}`);
                        } else {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Perfil de paciente criado com sucesso");
                        }
                    }
                } catch (err) {
    ...
    const handleDeleteUser = async (id)=>{
        const token = localStorage.getItem("token");
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteUserRequest"])(id, token || undefined);
            if (res.status === 204) {
                // removido com sucesso
                setUsers((prev)=>prev.filter((u)=>u._id !== id));
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Utilizador apagado com sucesso");
            } else {
                const payload = await res.json().catch(()=>null);
...
_s(UserManagement, "mq6Td3BsRtMQGH1nmbIJ1K7VDNI=", false, function() {
    return [
...
//# sourceMappingURL=_35323123._.js.map
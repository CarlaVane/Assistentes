...
function DoctorPreDiagnosisValidation() {
        ...
        "DoctorPreDiagnosisValidation.useEffect": ()=>{
            async function fetchPending() {
                try {
                    ...
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$consultas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPendingConsultasRequest"])(token);
                    if (!res.ok) throw new Error("Falha ao buscar consultas pendentes");
                    const json = await res.json();
                    setPendingPreDiagnoses(json.data || []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorPreDiagnosisValidation.useEffect": ()=>{
            async function fetchRecs() {
                if (!selectedReport || !selectedDoencaId) return;
                setLoadingRecomendacoes(true);
                try {
                    const recs = [];
                    const dRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$doenca$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoencaRequest"])(selectedDoencaId);
                    if (dRes.ok) {
                        const d = await dRes.json();
                        d.data?.recomendacoes?.forEach({
                            "DoctorPreDiagnosisValidation.useEffect.fetchRecs": (r)=>recs.push({
                                    _id: r._id,
                                    nome: r.nome,
                                    descricao: r.descricao,
                                    origem: "doenca"
                                })
                        }["DoctorPreDiagnosisValidation.useEffect.fetchRecs"]);
                    }
                    if (selectedReport.symptomIds) {
                        await Promise.all(selectedReport.symptomIds.map({
                            "DoctorPreDiagnosisValidation.useEffect.fetchRecs": async (id)=>{
                                const sRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$sintomas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSintomaRequest"])(id);
                                if (sRes.ok) {
                                    const s = await sRes.json();
                                    s.data?.recomendacoes?.forEach({
                                        "DoctorPreDiagnosisValidation.useEffect.fetchRecs": (r)=>{
                                            if (!recs.find({
                                                "DoctorPreDiagnosisValidation.useEffect.fetchRecs": (x)=>x._id === r._id
                                            }["DoctorPreDiagnosisValidation.useEffect.fetchRecs"])) {
                                                recs.push({
                                                    _id: r._id,
                                                    nome: r.nome,
                    ...
                    setAvailableRecomendacoes(recs);
                } finally{
    ...
    async function handleValidate() {
        ...
        try {
            const token = localStorage.getItem("token");
            if (!token) return;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$consultas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["approveConsultaRequest"])(selectedReport.id, token);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$consultas$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateConsultaRequest"])(selectedReport.id, token, {
                ...
                recomendacoes_medicos: selectedRecomendacoes,
                recomendacoes_livres: validationNotes ? [
                    validationNotes
                ] : []
            });
            setPendingPreDiagnoses((p)=>p.filter((c)=>c.id !== selectedReport.id));
            setSelectedReport(null);
            alert("Consulta validada com sucesso");
        } catch (e) {
            alert(e.message);
        } finally{
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                className: "space-y-2",
                                children: pendingPreDiagnoses.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "w-full text-left p-2 border rounded",
                                        onClick: ()=>setSelectedReport(c),
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "font-medium",
                                                children: c.patientName
                                            }, void 0, false, {
                                                fileName: "[project]/components/doctor-pre-diagnosis-validation.tsx",
                                                lineNumber: 175,
                                                columnNumber: 17
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: !selectedReport ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    children: "Selecione uma consulta"
                                }, void 0, false, {
                                    fileName: "[project]/components/doctor-pre-diagnosis-validation.tsx",
                                    lineNumber: 188,
                                    columnNumber: 15
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                                            ...
                                            className: "space-y-4",
                                            children: [
                                                availableRecomendacoes.map((r)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-2",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$checkbox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Checkbox"], {
                                                                checked: selectedRecomendacoes.includes(r._id),
                                                                onCheckedChange: ()=>setSelectedRecomendacoes((p)=>p.includes(r._id) ? p.filter((i)=>i !== r._id) : [
                                                                            ...p,
                                                                            r._id
                                                                        ])
                                                            }, void 0, false, {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                    ...
                                                    children: isValidating ? "Validando..." : "Validar"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/doctor-pre-diagnosis-validation.tsx",
                                                    lineNumber: 228,
                                                    columnNumber: 19
...
_s(DoctorPreDiagnosisValidation, "H+K78pNzjE2zMDv/O+TiQ8QSQcQ=", false, function() {
    return [
...
//# sourceMappingURL=_e661a026._.js.map
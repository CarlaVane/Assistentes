...
function DoctorPreDiagnosisValidation() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchPending() {
            try {
                ...
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$consultas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPendingConsultasRequest"])(token);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$6_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchRecs() {
            ...
            try {
                const recs = [];
                const dRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$doenca$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDoencaRequest"])(selectedDoencaId);
                if (dRes.ok) {
                    const d = await dRes.json();
                    d.data?.recomendacoes?.forEach((r)=>recs.push({
                            _id: r._id,
                            nome: r.nome,
                ...
                if (selectedReport.symptomIds) {
                    await Promise.all(selectedReport.symptomIds.map(async (id)=>{
                        const sRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$sintomas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSintomaRequest"])(id);
                        if (sRes.ok) {
                            const s = await sRes.json();
                            s.data?.recomendacoes?.forEach((r)=>{
                                if (!recs.find((x)=>x._id === r._id)) {
                                    recs.push({
                                        _id: r._id,
                                        nome: r.nome,
                                        descricao: r.descricao,
    ...
    async function handleValidate() {
        ...
        try {
            const token = localStorage.getItem("token");
            if (!token) return;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$requests$2f$consultas$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["approveConsultaRequest"])(selectedReport.id, token);
...
//# sourceMappingURL=_505d64d6._.js.map